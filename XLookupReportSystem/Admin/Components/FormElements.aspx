<%@ Page Title="Form Elements" Language="C#" MasterPageFile="~/Admin/Components/Components.Master" AutoEventWireup="true" CodeBehind="FormElements.aspx.cs" Inherits="CommanderWebsite.Admin.Store.Components.FormElements" %>
              ...
              <div>
                ...
                <fieldset class="row mb-3">
                  ...
                  <div class="col-sm-10">
                    ...
                    <div class="form-check disabled">
                      <input class="form-check-input" type="radio" name="gridRadios" id="gridRadios" value="option" disabled="disabled"/>
                ...
                <div class="row mb-3">
                  ...
                  <div class="col-sm-10">
                    ...
                    <div class="form-check">
                      <input class="form-check-input" type="checkbox" id="gridCheck2" checked="checked"/>
                ...
                <div class="row mb-3">
                  ...
                  <div class="col-sm-10">
                    <input type="text" class="form-control" value="Read only / Disabled" disabled="disabled"/>
                  </div>
                </div>
