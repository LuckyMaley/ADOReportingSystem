...
{
    public partial class DownloadOverallProject : System.Web.UI.Page
    {
        public static List<string> checkedItemsList = new List<string>();
        protected void Page_Load(object sender, EventArgs e)
        {
                checkedItemsList = Projects.checkedItems;
            ...
            //        foreach (string str in checkedItemsList)
            //        {
            //            string projID = str;
            ...
            //        ws.Cells["C4"].Value = (AverageSI_Students_Pass_RateItem / checkedItemsList.Count).ToString();
            ...
            //        ws.Cells["F4"].Value = (AverageNon_SI_Students_Pass_RateItem / checkedItemsList.Count).ToString();
