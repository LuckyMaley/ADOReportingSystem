...
namespace XLookupReportSystem.Admin
{
    public partial class DashBoard : System.Web.UI.Page
    {
        ...
        protected void Createbtn_Click(object sender, EventArgs e)
        {
            ...
            decimal si_Student_Pass_Rate = Math.Round((decimal)noOfSI_Students_Passed / (decimal)noOfSI_Students * (decimal)100,2);
            ...
            decimal non_si_student_Pass_Rate = Math.Round((decimal)noOfNon_SI_Students_Passed / (decimal)noOfNon_SI_Students * (decimal)100,2);
            ...
            decimal overall_Students_Pass_Rate = Math.Round((decimal) noOfOverallStudentsPassed / (decimal) noOfOverallStudents * (decimal)100, 2);
